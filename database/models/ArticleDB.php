...
class ArticleDB 
{
  ...
  private PDOstatement $statementDeleteAllUserArticles;
  ...
  function __construct(private PDO $pdo)
  {
    ...
    $this->statementDeleteAllUserArticles = $pdo->prepare("DELETE FROM article WHERE article.author=:authorId");
  ...
  public function fetchUserArticles($authorId) {
  ...
  public function deleteAllUserArticles($authorId) {
    $this->statementDeleteAllUserArticles->bindValue(":authorId", $authorId);
    $this->statementDeleteAllUserArticles->execute();
